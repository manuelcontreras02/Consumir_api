        ...
        <div id="peli" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                foreach ($imagenes as $imagen) {
                    ...
                    echo "<img src='{$imagen->getImagenURL()}' class='card-img-top' alt=''poster peli'>";
                    echo   "<div class='card-body'>";
                    echo   "<h5 class='card-title'><b>{$imagen->getLikes()}</b></h5>";
                    echo "<p class='card-text'>{$imagen->getUser()}</p>";
                    echo "</div>";
                    echo " </div>";
                    echo "</div>";
                    $contador++;
